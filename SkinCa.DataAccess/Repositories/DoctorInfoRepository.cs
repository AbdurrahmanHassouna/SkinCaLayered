...
public class DoctorInfoRepository : IDoctorInfoRepository
{
    ...
    public async Task<DoctorInfo> GetDoctorInfoAsync(string doctorId)
    {
        try
        {
           ...
           if(doctorInfo == null) throw new NotFoundException($"Doctor with ID {doctorId} not found");
           return doctorInfo;
        }
    ...
    public async Task<bool> DeleteAsync(string userId)
    {
        try
        {
            ...
            if (doctorInfo == null) throw new NotFoundException($"Doctor with ID {userId} not found");
    ...
    public async Task<bool> UpdateAsync(DoctorInfo doctor)
    {
        try
        {
            ...
            if (existing == null) throw new NotFoundException($"Doctor with ID {doctor.UserId} not found");
